  ...
  return (
    <header className="relative z-[1000] border-b border-border bg-surface/90 px-6 py-4 backdrop-blur">
      ...
      <aside
        ...
        className={`fixed right-0 top-0 z-[1100] flex h-full w-[90vw] max-w-sm flex-col gap-6 overflow-y-auto border-l border-border bg-background px-6 py-6 shadow-xl transition-transform md:hidden ${
