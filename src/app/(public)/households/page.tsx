      ...
      <section className="rounded-xl border border-border p-4">
        ...
        <form onSubmit={onCreateHousehold} className="flex flex-wrap gap-3">
          <input
            ...
            required
          />
          <button type="submit" className="rounded-md bg-primary px-4 py-2 text-primary-foreground transition hover:bg-primary-hover">
            Create
          </button>
        </form>
      </section>
      ...
      <section className="rounded-xl border border-border p-4">
        ...
        <form onSubmit={onInviteMember} className="grid gap-3 md:grid-cols-[1fr_auto_auto]">
          ...
          <button
            ...
            className="rounded-md bg-primary px-4 py-2 text-primary-foreground transition hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-60"
          >
            Add member
          </button>
        </form>
