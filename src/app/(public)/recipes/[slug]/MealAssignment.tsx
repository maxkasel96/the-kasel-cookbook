    ...
    >
      ...
      <div className="recipe-meal-assignment__footer">
        <button
          ...
          className="recipe-detail-primary-action recipe-meal-assignment__button px-4 py-2 text-sm font-semibold shadow-sm transition disabled:cursor-not-allowed disabled:opacity-60"
        >
